...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData(){
                this.$fetch('/v1/fileManager',this.queryData)
                    .then((response) => {
            ...
            submitApp(){
                ...
                if(_.isEmpty(this.formData._id)){
                    this.$post('/v1/fileManager',this.formData)
                        .then((response) => {
                            console.log(response)
                            this.getData();
                            this.formData={};
                    ...
                    this.$put('/v1/fileManager/'+this.formData._id,this.formData)
                        .then((response) => {
                            console.log(response)
                            this.getData();
                            this.formData={};
            ...
            handleClick(tab, event) {
                ...
                this.$fetch('/v1/fileManager',{_id:tab._id})
                    .then((response) => {
                        console.log(response)
            ...
            deleteClick(tab, event) {
                console.log(tab, event);
                this.$delete('/v1/fileManager/'+tab._id)
                    .then((response) => {
                        console.log(response)
                        this.getData();
                    })
