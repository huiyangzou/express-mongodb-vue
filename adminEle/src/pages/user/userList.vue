...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData(){
                this.$fetch('/v1/users',this.queryData)
                    .then((response) => {
            ...
            submitApp(){
                ...
                if(_.isEmpty(this.formData._id)){
                    this.$post('/v1/users',this.formData)
                        .then((response) => {
                            console.log(response)
                            this.getData();
                            this.formData={};
                    ...
                    this.$put('/v1/users/'+this.formData._id,this.formData)
                        .then((response) => {
                            console.log(response)
                            this.getData();
                            this.formData={};
            ...
            handleClick(tab, event) {
                ...
                this.$fetch('/v1/users',{_id:tab._id})
                    .then((response) => {
                        console.log(response)
